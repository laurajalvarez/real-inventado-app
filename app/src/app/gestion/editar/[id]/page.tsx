...
export default async function EditarPreguntaPage({
  ...
  const question =
    managedQuestions.find((item) => item.id === id) ?? managedQuestions[0];
          ...
          <form className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <div className="field-shell surface-elevated rounded-xl p-1">
                  ...
                  >
                    {categoryOptions
                      .filter((category) => category !== "Todas las categorias")
                      .map((category) => (
              ...
              <div className="space-y-2">
                ...
                <div className="field-shell surface-elevated rounded-xl p-1">
                  <select
                    ...
                    className="w-full rounded-md border-none bg-transparent px-4 py-4 text-white outline-none"
                  >
                    <option value="Activa" className="bg-[#161616]">
                      Activa
                    </option>
                    <option value="Borrador" className="bg-[#161616]">
                      Borrador
                    </option>
                  </select>
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="field-shell surface-elevated rounded-xl p-1">
                <select
                  defaultValue={
                    question.answers.find((answer) => answer.correct)?.label ?? "Real"
                  }
                  className="w-full rounded-md border-none bg-transparent px-4 py-4 text-white outline-none"
                >
                  <option value="Real" className="bg-[#161616]">
                    Real
                  </option>
                  <option value="Inventado" className="bg-[#161616]">
                    Inventado
                  </option>
                </select>
              </div>
            ...
            <div className="grid gap-4 pt-2 sm:grid-cols-3">
              <button
                type="submit"
                className="btn-primary font-headline flex items-center justify-center rounded-md py-4 text-lg font-extrabold"
              >
                Guardar
              </button>
              ...
              <button
                type="button"
                className="rounded-md border border-[rgba(255,178,185,0.24)] bg-[rgba(167,1,56,0.22)] py-4 text-lg font-black uppercase tracking-[0.18em] text-[rgb(255,178,185)]"
              >
                Eliminar
              </button>
